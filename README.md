...
- [Velocity-based (dead reckoning)](docs/differential_drive_robots_and_wheel_odometry.ipynb#1-velocity-based--dead-reckoning-)
  - [Forward Kinematics for Differential Drive Robots](docs/differential_drive_robots_and_wheel_odometry.ipynb#11-forward-kinematics-for-differential-drive-robots)
  - [Inverse Kinematics of Differential Drive Robots](docs/differential_drive_robots_and_wheel_odometry.ipynb#12--inverse-kinematics-of-differential-drive-robots)
  - [Odometry-based](docs/differential_drive_robots_and_wheel_odometry.ipynb#2-odometry-based)
...
- [1. Global References](docs/imu.ipynb#1-global-references)
- [2. Accelerometer Model](docs/imu.ipynb#2-accelerometer-model)
- [3. Gyroscope Model](docs/imu.ipynb#3-gyroscope-model)
- [4. Attitude from gravity (Tilt)](docs/imu.ipynb#4-attitude-from-gravity--tilt-)
  * [4.1. Solving R xyz for the Pitch and Roll Angles](docs/imu.ipynb#41-solving-r-xyz-for-the-pitch-and-roll-angles)
  * [4.2 Solving R yxz for the Pitch and Roll Angles](docs/imu.ipynb#42-solving-r-yxz-for-the-pitch-and-roll-angles)
- [Expressing IMU reading with Quaternion](docs/imu.ipynb#expressing-imu-reading-with-quaternion)
- [5. Quaternion from Accelerometer](docs/imu.ipynb#5-quaternion-from-accelerometer)
- [6. Quaternion Integration](docs/imu.ipynb#6-quaternion-integration)
  * [6.1. Numerical Solution](docs/imu.ipynb#61-numerical-solution)
  * [6.2. Closed-form Solution](docs/imu.ipynb#62-closed-form-solution)
- [7.1 Quaternion Derivative](docs/imu.ipynb#71-quaternion-derivative)
- [Relationship Between Euler-Angle Rates and Body-Axis Rates](docs/imu.ipynb#relationship-between-euler-angle-rates-and-body-axis-rates)
- [Complementary Filter](docs/imu.ipynb#complementary-filter)
- [Quaternion-Based Complementary Filter](docs/imu.ipynb#quaternion-based-complementary-filter)
- [Accelerometer-Based Correction](docs/imu.ipynb#accelerometer-based-correction)
- [Attitude from angular rate (Attitude propagation)](docs/imu.ipynb#attitude-from-angular-rate--attitude-propagation-)
- [IMU Integration](docs/imu.ipynb#imu-integration)
- [Noise Spectral Density](docs/imu.ipynb#noise-spectral-density)
- [Signal-to-noise Ratio](docs/imu.ipynb#signal-to-noise-ratio)
- [Allan Variance curve](docs/imu.ipynb#allan-variance-curve)
  * [Variance](docs/imu.ipynb#variance)
  * [M-sample variance](docs/imu.ipynb#m-sample-variance)
  * [Allan Variance](docs/imu.ipynb#allan-variance)
- [Autoregressive model](docs/imu.ipynb#autoregressive-model)
- [Madgwick Orientation Filter](docs/imu.ipynb#madgwick-orientation-filter)
- [Mahony Orientation Filter](docs/imu.ipynb#mahony-orientation-filter)
- [Simulating IMU Measurements](docs/imu.ipynb#simulating-imu-measurements)
- [IMU Propagation Derivations](docs/imu.ipynb#imu-propagation-derivations)
  * [The IMU Noise Model](docs/imu.ipynb#the-imu-noise-model)
    + [Additive "White Noise"](docs/imu.ipynb#additive--white-noise-)
    + [Bias](docs/imu.ipynb#bias)
    + [The Noise Model Parameters in Kalibr](docs/imu.ipynb#the-noise-model-parameters-in-kalibr)
  * [How to Obtain the Parameters for your IMU](docs/imu.ipynb#how-to-obtain-the-parameters-for-your-imu)
    + [From the Datasheet of the IMU](docs/imu.ipynb#from-the-datasheet-of-the-imu)
    + [From the Allan standard deviation (AD)](docs/imu.ipynb#from-the-allan-standard-deviation--ad-)
...
# [Shape Analysis](#)
- [Procrustes Analysis](docs/shape_analysis.ipynb#procrustes-analysis)
- [Wahba's Problem](docs/shape_analysis.ipynb#wahba-s-problem)
- [Quaternion Estimator Algorithm (QUEST)](docs/shape_analysis.ipynb#quaternion-estimator-algorithm--quest-)
